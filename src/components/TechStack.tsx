...
const TECHS = [
  { label: 'JS', color: '#f7df1e', size: 76 },
  { label: 'React', color: '#61dafb', size: 84 },
  { label: 'HTML', color: '#e34f26', size: 70 },
  { label: 'CSS', color: '#1572b6', size: 66 },
  { label: 'Node', color: '#339933', size: 80 },
  { label: 'Firebase', color: '#ffca28', size: 68 },
  { label: 'Git', color: '#f05032', size: 72 },
  { label: 'TS', color: '#3178c6', size: 64 },
  { label: 'C', color: '#9ecfe8', size: 60 },
  { label: 'Vite', color: '#bd34fe', size: 62 },
]
